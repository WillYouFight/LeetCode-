...
public class  Main{
    public static void main(String[] args) {
        ...
        System.out.println(test.addQuestion(question1));//true
        System.out.println(test.addQuestion(question2));//true
        System.out.println(test.addQuestion(question3));//true
        System.out.println(test.addQuestion(question4));//true
        System.out.println(test.addQuestion(question5));//true
        System.out.println(test.start());///true
        System.out.println(test.isEmpty());//false
        System.out.println(test.isFull());//true
        System.out.println(test.getQuestion());
        System.out.println(test.check("a"));//true
        System.out.println(test.check("b"));//true
        System.out.println(test.check("a"));//true
        System.out.println(test.check("d"));//true
        System.out.println(test.check("d"));//fale
